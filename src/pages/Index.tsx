  ...
  return <div className="min-h-screen bg-background pb-24">
      ...
      <div className="max-w-md mx-auto px-6 py-6 space-y-6">
        ...
        <div className="space-y-3">
          ...
          <NavigationTile icon={Brain} title="Mindfulness" description="Meditate, breathe, and find calm" gradient="bg-gradient-to-br from-mint/30 to-sky/30" onClick={() => navigate("/mindfulness")} />
          <NavigationTile icon={Zap} title="Productivity" description="Boost your focus and energy" gradient="bg-gradient-to-br from-peach/30 to-mood-excited/20" onClick={() => navigate("/productivity")} />
          <NavigationTile icon={Target} title="Personal Calendar" description="Track habits and goals" gradient="bg-gradient-to-br from-lavender/30 to-secondary/30" onClick={() => navigate("/calendar")} />
          <NavigationTile icon={Bot} title="AI Buddy" description="Chat with your wellness assistant" gradient="bg-gradient-to-br from-sky/30 to-primary/30" onClick={() => navigate("/ai-buddy")} />
        </div>
      </div>
